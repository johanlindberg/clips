...
(bsave "foo.bin")                  ; DR0604
(clear)                            ; DR0604
(defrule bar => (assert (y)))      ; DR0604
(bsave "bar.bin")                  ; DR0604
(clear)                            ; DR0604
(bload "foo.bin")                  ; DR0604
(reset)                            ; DR0604
(run)                              ; DR0604
(facts)                            ; DR0604
(bload "bar.bin")                  ; DR0604
(reset)                            ; DR0604
(run)                              ; DR0604
(facts)                            ; DR0604
(clear)                            ; DR0606
...
(clear)                            ; DR0610
(release-mem)                      ; DR0610 - Memory Loss
(clear)                            ; DR0612
(release-mem)                      ; DR0612
(defrule x (not (a)) =>)           ; DR0612
(clear)                            ; DR0612
(release-mem)                      ; DR0612 - Memory Loss
(clear)                            ; DR0613
(release-mem)                      ; DR0613
(defrule x (not (a)) (not (b))  =>) 
(clear)                            ; DR0613
(release-mem)                      ; DR0613 - Memory Loss
(clear)                            ; DR0614
(release-mem)                      ; DR0614
(defglobal ?*x* = 3)               ; DR0614
(defglobal ?*x* = 4)               ; DR0614
(clear)                            ; DR0614
(release-mem)                      ; DR0614 - Memory Loss
(clear)                            ; DR0615
(release-mem)                      ; DR0615
(deftemplate x (multifield y) (multifield y))
(clear)                            ; DR0615
(release-mem)                      ; DR0615 - Memory Loss
(clear)                            ; DR0616
(release-mem)                      ; DR0616
(any-instancep ((?a OBJECT) (?a OBJECT)) TRUE)
(clear)                            ; DR0616
(release-mem)                      ; DR0616 - Memory Loss
(clear)                            ; DR0617
(release-mem)                      ; DR0617
(bind ?a 3)                        ; DR0617
(clear)                            ; DR0617
(release-mem)                      ; DR0617 - Memory Loss
(clear)                            ; DR0619
(str-explode "")                   ; DR0619
...
(defrule a                         ; DR0625
   ...
   =>)
(clear)                            ; DR0625
(release-mem)                      ; DR0625 - Memory Loss
(clear)                            ; DR0626
(deffacts one                      ; DR0626
...
(constructs-to-c bug 1)            ; DR0647
(describe-class B)                 ; DR0647
(clear)                            ; DR0648
(bsave "none.bin")                 ; DR0648
(deffunction one ())               ; DR0648
(bsave "some.bin")                 ; DR0648
(bload "none.bin")                 ; DR0648
(clear)                            ; DR0649
(div a)                            ; DR0649
(div 1)                            ; DR0649
(asin 2)                           ; DR0649
