...
(bsave "drtest06.bin")             ; DR0504
(bload "drtest06.bin")             ; DR0504
(bload "drtest06.bin")             ; DR0504
(clear)                            ; DR0504
(clear)                            ; DR0506
(retract *)                        ; DR0506
...
(bsave "drtest06.bin")             ; DR0575
(clear)                            ; DR0575
(bload "drtest06.bin")             ; DR0575
(clear)                            ; DR0575
(clear)                            ; DR0576
...
(instances)                        ; DR0584
(save-instances "drtest06.tmp")    ; DR0584
(unmake-instance a)                ; DR0584
(load-instances "drtest06.tmp")    ; DR0584
(instances)                        ; DR0584
(restore-instances "drtest06.tmp") ; See CRS
(instances)                        ; DR0584
(clear)                            ; DR0588
...
(release-mem)                      ; DR0592
(clear)                            ; DR0594
(defrule junk => (bsave drtest06.bin))     
(reset)                            ; DR0594
(run)                              ; DR0594
(bload drtest06.bin)               ; DR0594
(reset)                            ; DR0594
(run)                              ; DR0594
(div 11.0 .5)                      ; DR0595
(clear)                            ; DR0600
